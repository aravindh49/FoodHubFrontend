...
export const Button: React.FC<ButtonProps> = ({ 
  ...
  const variants = {
    primary: "bg-indigo-600 text-white hover:bg-indigo-700 active:scale-95 shadow-xl shadow-indigo-100",
    secondary: "bg-emerald-500 text-white hover:bg-emerald-600 active:scale-95 shadow-xl shadow-emerald-100",
